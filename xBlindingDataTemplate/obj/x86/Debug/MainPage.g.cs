#pragma checksum "C:\Users\My-PC\source\repos\xBlindingDataTemplate\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "470B1A5A20C54E7EBAD70D25C31A0989"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace xBlindingDataTemplate
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj3_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::xBlindingDataTemplate.Models.Book dataRoot;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 14 && columnNumber == 38)
                {
                    isobj5TextDisabled = true;
                }
                else if (lineNumber == 15 && columnNumber == 38)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::xBlindingDataTemplate.Models.Book) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::xBlindingDataTemplate.Models.Book)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::xBlindingDataTemplate.Models.Book obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::xBlindingDataTemplate.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::xBlindingDataTemplate.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::xBlindingDataTemplate.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Books(global::System.Collections.Generic.List<global::xBlindingDataTemplate.Models.Book> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
